        ...
        <div class="col-sm-12 col-lg-12 col-md-12 col-xs-12">
			...
			<br>
                ...
                <table style="width:100%" class="text-center">
						...
						<?php 
//ke imame 3 promenlivi: pdfHere, docxHere, txtHere
									$txtHere = False;
									$pdfHere = False;
									$docxHere = False;
		...
		<!--FILE 2-->
                            ...
                            <?php
//ke imame 3 promenlivi: pdfHere2, docxHere2, txtHere2
								$txtHere2 = False;
								$pdfHere2 = False;
								$docxHere2 = False;
		...
		<!--FILE 2-->
						<td>
                            <?php
								...
								$str2 = explode(" ", $brisi_interpuncii2);
		...
		<!--FILE 2-->
						<td>
                            <?php
								...
								$str_i2 = preg_replace('#[[:punct:]]#', '', $str2);
		...
		<!--FILE 2-->
						<td>
                            <?php
								...
								{									
									if(strpos($str2[$i], '.')){
										$sobiraj_zborovi2 += mb_strlen($str2[$i]);
