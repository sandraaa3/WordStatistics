	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			{ 
				...
				if(val=='' && val2=='') 
				{ 
					alert("Empty input FILE 1 and FILE 2 with standard encoding!"); 
				} 
				else if(val=='' && val2!='') 
				{ 
					alert("Empty input FILE 1  with standard encoding!"); 
				}
				else if(val!='' && val2=='') 
				{ 
					alert("Empty input FILE 2  with standard encoding!"); 
				}
				else{
					showLoading();
					$.ajax({
		...
		$(document).ready(function() {
			$('#upload2').bind("click",function() 
				{ 
					...
					if(val=='' && val2=='') 
					{ 
						alert("Empty input FILE 1 and FILE 2 with special encoding!"); 
					} 
					else if(val=='' && val2!='') 
					{ 
						alert("Empty input FILE 1  with special encoding!"); 
					}
					else if(val!='' && val2=='') 
					{ 
						alert("Empty input FILE 2  with special encoding!"); 
					}
					else{
						showLoading();
						$.ajax({
				...
				<div class="panel panel-success">
				  <div class="panel-body" style="padding-left: 40px; padding-bottom: 40px;">
								<form action="compare_two_files_analysis.php" method="post" enctype="multipart/form-data" style="float: left;">
								  ...
								  Choose two files with standard enconding:</b></h3></label>
								  <br><br>
						...
						<div class="panel panel-info" id="div_special_font">
						  <div class="panel-body" style="padding-left: 40px; padding-bottom: 40px;">
								<form action="compare_two_files_analysis_utf_8.php" method="post" enctype="multipart/form-data" style="float: left;">
								  ...
								  Choose two files with special encoding:</b></h3></label>
								  <br><br>
